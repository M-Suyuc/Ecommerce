...
import { clearCart, DeleteProduct, getCartTotal, toggleCartQty } from '../features/cartSlice'
      ...
      products.map(product => {
        ...
        return (
          <article key={id} className='my-4 border-b border-gray-300 pb-4'>
              ...
              <div className='flex justify-between gap-4'>
                ...
                <div className='flex flex-col justify-between'>
                  ...
                  <div className='flex gap-1 md:gap-4 items-center'>
                    <button className='font-semibold px-3 py-1 border border-slate-300 hover:bg-gray-300' onClick={() => dispatch(toggleCartQty({ id, option: 'DEC' }))}>-</button>
                    <span>{quantity}</span>
                    <button className='font-semibold  px-3 py-1 border border-slate-300 hover:bg-gray-300' onClick={() => dispatch(toggleCartQty({ id, option: 'INC' }))}>+</button>
                  </div>
                  <div>
            ...
            {/* --- */}
            <button className='w-20 inline-flex justify-center' onClick={() => dispatch(DeleteProduct(id))}>
      ...
      <>
        ...
        <div className='flex flex-col md:flex-row gap-8'>
          <div className='w-full md:w-[60%] lg:w-[65%] min-h-[170px]'>
            ...
            <button className='bg-red-700 py-1 px-4 text-white font-semibold' onClick={() => dispatch(clearCart())}>Clear Cart</button>
          </div>
